...
const marketNames: Record<Locale, string> = {
  en: 'London (EN)',
  fr: 'France (FR)',
};
  ...
  return (
    <>
      ...
      <main className="admin-page">
        ...
        {locales.map((market) => {
          const data = getLaunchRegistrationAdminData(market);
          ...
          return (
            <div key={market}>
              ...
              <section
                className="admin-registrations"
                aria-labelledby={`registration-list-${data.market}`}
              >
                <header>
                  <div>
                    <p className="eyebrow">Latest first</p>
                    <h2 id={`registration-list-${data.market}`}>
                      {marketNames[data.market]} launch list
                    </h2>
                  </div>
